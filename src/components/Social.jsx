    ...
    <StyledWrapper>
      <div className="social-login-icons">
        <div
          ...
          onClick={() => window.open("https://x.com/5fkkGNYIUbVX088", "_blank")}
        >
        ...
        <div
          className="socialcontainer"
          onClick={() =>
            window.open("https://www.instagram.com/red.bora/", "_blank")
          }
        >
        ...
        <div
          className="socialcontainer"
          onClick={() =>
            window.open("https://web.facebook.com/Who.unknow", "_blank")
          }
        >
        ...
        <div
          className="socialcontainer"
          onClick={() => window.open("https://github.com/borared", "_blank")}
        >
